    ...
    <>
      {loading ? (
        <div className="flex flex-col mt-24 flex-grow">
          <div className="animate-pulse mx-auto max-w-2xl py-8 md:py-16 px-4 sm:py-24 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            {/* Product details */}
            ...
            <div className="mt-10 bg-slate-300 rounded-xl lg:col-start-2 lg:row-span-2 lg:mt-0 lg:self-center">
              <div className="sm:h-80 sm:w-80 md:h-96 md:w-96 aspect-w-1 aspect-h-1 overflow-hidden rounded-lg">
                &nbsp;
              </div>
            </div>
        ...
        <div className="flex flex-col flex-grow mt-24">
          <div className="mx-auto max-w-2xl py-8 md:py-16 px-4 sm:py-24 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            {/* Product details */}
            <div className="lg:max-w-lg lg:self-end">
              <div className="mt-4">
